...
namespace PocBattle.Runtime
{
    ...
    public readonly struct RunStatusSnapshot
    {
        ...
        /// <summary>Gets current physical deck count.</summary>
        public int DeckCount => _deckCount;

        /// <summary>Gets player deck capacity.</summary>
    ...
    /// <summary>
    /// Immutable world loot presentation snapshot.
    /// </summary>
    public readonly struct LootDropSnapshot
    {
        ...
        /// <summary>Gets whether a world loot block should be visible.</summary>
        public bool IsVisible => _isVisible;

        /// <summary>Gets the offered player block definition.</summary>
        ...
        public LootDropSnapshot(bool isVisible, BlockDefinitionSO definition, Vector3 worldPosition)
        {
    ...
    /// </summary>
    public readonly struct DeckBlockSelectionSnapshot
    {
        ...
        /// <summary>Gets whether this physical block is currently selected for discard.</summary>
        public bool IsSelected => _isSelected;

        /// <summary>Creates one immutable discard-selection row.</summary>
        public DeckBlockSelectionSnapshot(int instanceId, BlockDefinitionSO definition, bool isSelected)
        {
    ...
    /// <summary>
    /// Snapshot for the full runtime deck while choosing up to three blocks to discard.
    /// </summary>
    public sealed class DeckDiscardSelectionSnapshot
    {
        ...
        private readonly DeckBlockSelectionSnapshot[] _items;
        private readonly int _selectedCount;

        /// <summary>Gets runtime deck rows.</summary>
        public DeckBlockSelectionSnapshot[] Items => _items;
        ...
        public DeckDiscardSelectionSnapshot(DeckBlockSelectionSnapshot[] items, int selectedCount)
        {
            _items = items;
